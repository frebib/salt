...
VALID_OPTS = immutabletypes.freeze(
    {
        ...
        # When set to True the minion will no longer initialize any pillars when it
        # starts.  The pillars can be fetched later via a manual operation like
...
DEFAULT_MASTER_OPTS = immutabletypes.freeze(
    {
        ...
        "audit_log_fmt": "json",
        "audit_log_hmac_key": salt.utils.stringutils.to_bytes(
